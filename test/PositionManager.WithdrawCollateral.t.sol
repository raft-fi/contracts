...
contract PositionManagerWithdrawCollateralTest is TestSetup {
    ...
    function testNoActivePosition() public {
        ...
        vm.prank(BOB);
        positionManager.managePosition(collateralToken, 0.1 ether, false, 0, false, BOB, BOB, 0);

        // Carol with no active position attempts to withdraw
        vm.prank(CAROL);
        vm.expectRevert(bytes("ERC20: burn amount exceeds balance"));
        positionManager.managePosition(collateralToken, 1 ether, false, 0, false, CAROL, CAROL, 0);
    }
    ...
    function testWithdrawAmountExceedsCollateral() public {
        ...
        positionManager.managePosition(collateralToken, carolPositionCollateral, false, 0, false, CAROL, CAROL, 0);

        // Bob attempts to withdraw 1 wei more than his collateral
        vm.prank(BOB);
        vm.expectRevert("ERC20: burn amount exceeds balance");
        positionManager.managePosition(collateralToken, bobPositionCollateral + 1, false, 0, false, BOB, BOB, 0);
    }
    ...
    function testDisallowedFullWithdrawal() public {
        ...
        vm.prank(ALICE);
        vm.expectRevert(abi.encodeWithSelector(IPositionManager.NewICRLowerThanMCR.selector, 0));
        positionManager.managePosition(collateralToken, alicePositionCollateral, false, 0, false, ALICE, ALICE, 0);
    }
    ...
    function testOpenPositionAfterPartialWithdrawal() public {
        ...
        vm.prank(ALICE);
        positionManager.managePosition(collateralToken, 1e17, false, 0, false, ALICE, ALICE, 0);
    ...
    function testPositionCollateralReduction() public {
        ...
        vm.prank(ALICE);
        positionManager.managePosition(collateralToken, withdrawAmount, false, 0, false, ALICE, ALICE, 0);
