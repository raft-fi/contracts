...
/// @dev This contract is needed to inform Tellor tipper bot to do a tip because of two potential
///     unreliability of Chainlink.
/// Two things changed from the original ChainlinkPriceOracle contract:
///     MAX_PRICE_DEVIATION_FROM_PREVIOUS_ROUND is 15% instead of 25% in the original contract.
///     TIMEOUT is 2 hours instead of 3 hours in the original contract.
contract ChainlinkPriceOracleReporter is IChainlinkPriceOracle {
    // --- Types ---
    ...
    constructor(AggregatorV3Interface _priceAggregatorAddress, IWstETH _wstETH) {
