...
/*
 * Based on https://github.com/livepeer/protocol/blob/master/contracts/libraries/SortedDoublyLL.sol
 * with updated version of solidity.
 *
...
library SortedDoublyLL {
     ...
     * @param _nextId Id of next node for the new insert position
     */
    function reInsert(Data storage self, address _id, uint256 _newKey, address _prevId, address _nextId) internal {
        require(contains(self, _id));
        require(_newKey != 0);
