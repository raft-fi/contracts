...
contract TroveManager is LiquityBase, Ownable, CheckContract, ITroveManager {
    ...
    */
    function liquidateTroves(uint256 _n) external override {
        ...
        LiquidationTotals memory totals = _getTotalsFromLiquidateTrovesSequence_NormalMode(
    ...
    */
    function batchLiquidateTroves(address[] memory _troveArray) public override {
        ...
        LiquidationTotals memory totals = _getTotalsFromBatchLiquidate_NormalMode(
    ...
    function _redeemCollateralFromTrove(
        ...
        uint256 newDebt = (Troves[_borrower].debt) - singleRedemption.LUSDLot;
    ...
    */
    ...
    function _getCurrentTroveAmounts(address _borrower) internal view returns (uint256, uint256) {
        ...
        uint256 currentLUSDDebt = Troves[_borrower].debt + pendingLUSDDebtReward;
    ...
    function getPendingLUSDDebtReward(address _borrower) public view override returns (uint256) {
        ...
        uint256 rewardPerUnitStaked = L_LUSDDebt - snapshotLUSDDebt;

        if (rewardPerUnitStaked == 0 || Troves[_borrower].status != Status.active) return 0;

        uint256 stake = Troves[_borrower].stake;

        uint256 pendingLUSDDebtReward = stake * rewardPerUnitStaked / DECIMAL_PRECISION;
    ...
    function _removeStake(address _borrower) internal {
        totalStakes -= Troves[_borrower].stake;
        ...
        internal
    {
        ...
        */
        ...
        uint256 LUSDDebtNumerator = _debt * DECIMAL_PRECISION + lastLUSDDebtError_Redistribution;

        // Get the per-unit-staked terms
        uint256 ETHRewardPerUnitStaked = ETHNumerator / totalStakes;
        uint256 LUSDDebtRewardPerUnitStaked = LUSDDebtNumerator / totalStakes;
    ...
    */
        ...
        returns (uint256)
    {
        ...
        * the fraction of total supply that was redeemed at face value. */
        uint256 redeemedLUSDFraction = _ETHDrawn * _price / _totalLUSDSupply;

        uint256 newBaseRate = (decayedBaseRate + redeemedLUSDFraction) / BETA;
        // TODO: Use OZ min here
