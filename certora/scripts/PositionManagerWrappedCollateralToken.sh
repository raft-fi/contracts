...
certoraRun certora/contracts/PositionManagerWrappedCollateralTokenHarness.sol:PositionManagerWrappedCollateralTokenHarness \
            ...
            --verify PositionManagerWrappedCollateralTokenHarness:certora/specs/PositionManagerWrappedCollateralToken.spec \
            --optimistic_loop \
            --solc_via_ir \
            --solc_optimize \
            --cache PositionManagerWrappedCollateralToken \
