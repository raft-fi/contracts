...
class TroveManagerProxy extends Proxy {
  ...
  async borrowingSpread() {
    return this.proxyFunction('borrowingSpread', [])
  }
  ...
  async setBorrowingSpread(...params) {
    return this.forwardFunction(params, 'setBorrowingSpread(uint256)')
  }
